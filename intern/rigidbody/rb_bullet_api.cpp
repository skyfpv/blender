...
void RB_body_set_ccd(rbRigidBody *object, bool active, float threshold, float radius)
{
	btRigidBody *body = object->body;
  if (active) {
...
void RB_body_set_ccd_motion_threshold(rbRigidBody *object, float value)
{
	btRigidBody *body = object->body;
	body->setCcdMotionThreshold(value);
}

void RB_body_set_ccd_swept_sphere_radius(rbRigidBody *object, float value)
{
	btRigidBody *body = object->body;
